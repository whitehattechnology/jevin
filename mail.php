...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	try {
		...
		$headers .= "From: \"Your Name\" <damianpreciado@whitehatdemocrats.com>\r\n";
		$headers .= "Reply-To: damianpreciado@whitehatdemocrats.com";

		// Send the mail
		if ( mail("damianpreciado@whitehatdemocrats.com", $subject, $body, $headers) ) {
			echo "1";
		}
	}
	catch (Exception $e) {
